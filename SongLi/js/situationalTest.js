$(document).ready(function () {
  ...
  function ajax() {
    $.ajax({
      ...
      $('#buttonSP').html(
        `<button id="next"><img class="w-100" src="../image/test/next_1.png"></button>`
      );
      $('#result').append(`
